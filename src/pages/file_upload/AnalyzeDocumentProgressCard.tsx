...
import { replaceLineBreaksWithReactNode } from "../../data/errorsSlice";



export function AnalyzeDocumentProgressCard({stage, inputFiles, error, progress, spreadsheetId, result}: ProcessingRun) {
        ...
        <Card>
            <CardContent sx={{textAlign: 'center'}}>
                ...
                <Accordion>
                    ...
                    <AccordionDetails>
                        <List>
                            {inputFiles.map((filename) => <ListItem key={filename}>{filename}</ListItem>)}
                        </List>
                    </AccordionDetails>
                </Accordion>
            ...
            {result && 
                <Accordion>
                    ...
                    <AccordionDetails>
                        <List>
                            {Object.values(result).flatMap((statements) => statements.map((stmt) => <ListItem key={stmt}>{stmt}</ListItem>))}
                        </List>
                    </AccordionDetails>
                </Accordion>
            }
